...
function EmployeeProfileForm({ employee, onSave, onCancel, saving = false }) {
  ...
  const sections = [
    {
      ...
      fields: [
        ...
        { name: 'fatherMotherName', label: "Father's / Mother's Name (Optional)", type: 'text' },
    ...
    {
      id: 'job',
      title: 'Company / Job-Related Information',
      fields: [
        ...
        { name: 'joinDate', label: 'Date of Joining (DOJ)', type: 'date' },
